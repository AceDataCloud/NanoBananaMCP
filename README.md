...
Install the [NanoBanana MCP plugin](https://plugins.jetbrains.com/plugin/com.acedatacloud.mcp.nanobanana) from the JetBrains Marketplace, or configure manually:
