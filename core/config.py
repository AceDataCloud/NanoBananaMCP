"""Configuration management for MCP NanoBanana server."""
...
class Settings:
    ...
    request_timeout: float = field(
        default_factory=lambda: float(os.getenv("NANOBANANA_REQUEST_TIMEOUT", "1800"))
    )

    # Server Configuration
    server_name: str = field(default_factory=lambda: os.getenv("MCP_SERVER_NAME", "nanobanana"))
